...
base = '/home/philiph/Documents/Continual-Learning/runs/lqr/pusher_new/penalty'
models = ['multitask', 'hnet', 'si', 'ewc', 'coreset', 'finetune']
models_label = ['multitask (oracle)', 'hnet', 'si', 'ewc', 'coreset', 'finetuning']
