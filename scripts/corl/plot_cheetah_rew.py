...
base = '/home/philiph/Documents/Continual-Learning/runs/lqr/cheetah_body_new'
...
plt.subplots_adjust(wspace=0.13, hspace=0.1, left=0.07, right=0.985, top=0.93, bottom=0.07)
